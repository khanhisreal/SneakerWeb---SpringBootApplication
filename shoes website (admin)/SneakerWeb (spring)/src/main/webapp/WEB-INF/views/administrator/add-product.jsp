	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li><a href="${base}/admin/product/management"
					class="active"><span class="las la-receipt"></span> <span>Add
							products</span></a></li>
			...
			<div class="contact-box">
				...
				<div class="right">
					<sf:form enctype="multipart/form-data" modelAttribute="product"
						...
						<input type="file" id="fileProductPictures" name="productPictures" class="field" multiple="multiple">
